...
public class StageValidator {
  ...
  public boolean isValid(StageExecutionImpl stage) {
   ...
   * cloud provider.
   */
  private Optional<Schema> loadSchema(StageExecutionImpl stage) {
  ...
  private static Optional<String> getCloudProvider(StageExecutionImpl stage) {
