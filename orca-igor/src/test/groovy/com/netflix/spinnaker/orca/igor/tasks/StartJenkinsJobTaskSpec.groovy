...
class StartJenkinsJobTaskSpec extends Specification {
  ...
  def pipeline = PipelineExecution.newPipeline("orca")
    ...
    def "should trigger build without parameters"() {
        given:
        def stage = new StageExecution(pipeline, "jenkins", [master: "builds", job: "orca"])
  ...
  def "should trigger build with parameters"() {
      given:
      def stage = new StageExecution(pipeline, "jenkins", [master: "builds", job: "orca", parameters: [foo: "bar", version: "12345"]])
