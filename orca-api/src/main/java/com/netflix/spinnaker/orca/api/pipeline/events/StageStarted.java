...
/**
 * Emitted when a {@link StageExecution} has started.
 *
 * <p>This event is emitted for both top-level and synthetic stages.
 */
@NonnullByDefault
public interface StageStarted extends ExecutionEvent {
