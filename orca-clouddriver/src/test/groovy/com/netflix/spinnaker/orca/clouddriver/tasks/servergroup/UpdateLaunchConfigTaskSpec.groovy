...
class UpdateLaunchConfigTaskSpec extends Specification {
  ...
  def "prefers the ami from an upstream stage to one from deployment details"() {
    ...
    and:
      ...
      def bakeSynthetic1 =
        new StageExecution(stage.execution, "bake in $region", [ami: amiName, region: region, cloudProvider: "aws"])
      ...
      def bakeSynthetic2 = new StageExecution(stage.execution, "bake in $region",
