...
import com.amazon.spinnaker.orca.aws.lambda.traffic.model.*;
...
@Component
public class BlueGreenDeploymentStrategy
    extends BaseDeploymentStrategy<LambdaBlueGreenStrategyInput> {
