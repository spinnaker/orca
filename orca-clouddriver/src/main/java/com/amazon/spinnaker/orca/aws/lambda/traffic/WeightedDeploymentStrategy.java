...
import com.amazon.spinnaker.orca.aws.lambda.traffic.model.LambdaWeightedStrategyInput;
...
@Component
public class WeightedDeploymentStrategy
    extends BaseDeploymentStrategy<LambdaWeightedStrategyInput> {
