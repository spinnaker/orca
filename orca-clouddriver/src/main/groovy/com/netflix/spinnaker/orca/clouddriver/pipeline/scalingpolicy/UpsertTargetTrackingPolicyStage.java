...
import com.netflix.spinnaker.orca.clouddriver.tasks.scalingpolicy.UpsertTargetTrackingPolicyTask;
...
@Component
public class UpsertTargetTrackingPolicyStage implements StageDefinitionBuilder {

  @Override
  public <T extends Execution<T>> void taskGraph(Stage<T> stage, TaskNode.Builder builder) {
    builder
      .withTask("upsertTargetTrackingPolicy", UpsertTargetTrackingPolicyTask.class)
