...
class ApplySourceServerGroupCapacityTask extends AbstractServerGroupTask {
   ...
   */
  TargetServerGroupContext getTargetServerGroupContext(StageExecutionImpl stage) {
   ...
   */
  static StageExecutionImpl getAncestorDeployStage(ExecutionRepository executionRepository, StageExecutionImpl stage) {
   ...
   */
  static StageExecutionImpl getAncestorSnapshotStage(StageExecutionImpl stage) {
    def ancestors = stage.ancestors().findAll { ancestorStage ->
      ancestorStage.context.containsKey("sourceServerGroupCapacitySnapshot")
    }

    StageExecutionImpl ancestor = (ancestors != null && !ancestors.isEmpty()) ? ancestors[0] : stage.execution.stages.find {
