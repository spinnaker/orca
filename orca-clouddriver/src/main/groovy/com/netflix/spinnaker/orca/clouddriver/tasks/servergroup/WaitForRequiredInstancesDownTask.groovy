...
class WaitForRequiredInstancesDownTask extends AbstractWaitingForInstancesTask {
  ...
  static List<String> getSkippedInstances(StageExecutionImpl stage, List<Map> results = []) {
  ...
  static List<Map> getInstancesToDisable(StageExecutionImpl stage, List<Map> instances) {
  ...
  static List<Map> getKatoResults(StageExecutionImpl stage) {
