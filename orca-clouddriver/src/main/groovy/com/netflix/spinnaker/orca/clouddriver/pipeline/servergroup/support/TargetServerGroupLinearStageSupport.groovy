...
abstract class TargetServerGroupLinearStageSupport implements StageDefinitionBuilder, Nameable {
  ...
  void composeTargets(StageExecutionImpl parent, StageGraphBuilder graph) {
  ...
  private boolean isTopLevel(StageExecutionImpl stage) {
    return stage.parentStageId == null
  }

  private void composeStaticTargets(StageExecutionImpl stage, TargetServerGroup.Params params, StageGraphBuilder graph) {
  ...
  private void composeDynamicTargets(StageExecutionImpl stage, TargetServerGroup.Params params, StageGraphBuilder graph) {
  ...
  protected List<Map<String, Object>> buildStaticTargetDescriptions(StageExecutionImpl stage, List<TargetServerGroup> targets) {
