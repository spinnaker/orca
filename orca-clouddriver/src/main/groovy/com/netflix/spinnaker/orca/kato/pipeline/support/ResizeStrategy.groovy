...
interface ResizeStrategy {
  ...
  CapacitySet capacityForOperation(StageExecutionImpl stage, String account, String serverGroupName, String cloudProvider, Location location, OptionalConfiguration resizeConfig)
}
