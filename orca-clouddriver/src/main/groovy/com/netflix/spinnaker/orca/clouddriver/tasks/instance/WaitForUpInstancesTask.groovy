...
class WaitForUpInstancesTask extends AbstractWaitingForInstancesTask {
  ...
  @Override
  Map getAdditionalRunningStageContext(StageExecutionImpl stage, Map serverGroup) {
  ...
  static boolean allInstancesMatch(StageExecutionImpl stage,
                                   Map serverGroup,
                                   List<Map> instances,
  ...
  static int calculateTargetDesiredSize(StageExecutionImpl stage, Map serverGroup, Splainer splainer = NOOPSPLAINER) {
  ...
  static boolean useConfiguredCapacity(StageExecutionImpl stage, Map<String, Integer> current) {
  ...
  private static HealthCountSnapshot getHealthCountSnapshot(StageExecutionImpl stage, Map serverGroup) {
   ...
   */
  private static Map<String, Integer> getServerGroupCapacity(StageExecutionImpl stage, Map serverGroup) {
   ...
   */
  private static Map<String, Integer> getInitialTargetCapacity(StageExecutionImpl stage, Map serverGroup) {
