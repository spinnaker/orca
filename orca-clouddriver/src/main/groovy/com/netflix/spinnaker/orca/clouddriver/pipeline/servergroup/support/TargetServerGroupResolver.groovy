...
class TargetServerGroupResolver {
  ...
  List<TargetServerGroup> resolve(StageExecutionImpl stage) {
   ...
   * resolved.
   */
  static TargetServerGroup fromPreviousStage(StageExecutionImpl stage) {
  ...
  private static boolean isDTSGStage(StageExecutionImpl stage) {
