...
/**
 * An interface to the Kato REST API for Amazon cloud. See {@see http://kato.test.netflix.net:7001/manual/index.html}.
 */
public interface KatoRestService {
  /**
   * @deprecated Use {@code /{cloudProvider}/ops} instead
   */
  @Deprecated @POST("/ops") TaskId requestOperations(
   ...
   * clouddriver replica).
   */
  @GET("/task/{id}") Task lookupTask(@Path("id") String id);
}
