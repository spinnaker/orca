...
@Component
public class UpsertTencentScheduledActionsTask implements Task {
  ...
  public TaskResult execute(Stage stage) {
                ...
                new ArrayList<Map<String, Map>>() {
                  {
                    add(
                        new HashMap<String, Map>() {
                          {
                            put("upsertTencentScheduledActionsDescription", stage.getContext());
                          }
                        });
                  }
                })
    ...
    return TaskResult.builder(ExecutionStatus.SUCCEEDED)
        .context("notification.type", "upserttencentscheduledactions")
