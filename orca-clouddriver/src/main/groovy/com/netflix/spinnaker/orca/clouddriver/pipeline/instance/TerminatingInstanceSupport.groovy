...
class TerminatingInstanceSupport implements CloudProviderAware {
   ...
   */
  List<TerminatingInstance> remainingInstances(StageExecutionImpl stage) {
  ...
  List<TerminatingInstance> getRemainingInstancesFromServerGroup(StageExecutionImpl stage, String serverGroupName, List<TerminatingInstance> terminatingInstances) {
   ...
   */
  List<TerminatingInstance> getRemainingInstancesFromSearch(StageExecutionImpl stage, List<TerminatingInstance> terminatingInstances) {
    String cloudProvider = getCloudProvider(stage)
