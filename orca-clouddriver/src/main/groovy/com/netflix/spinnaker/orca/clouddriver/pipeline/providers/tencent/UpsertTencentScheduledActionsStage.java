...
@Component
public class UpsertTencentScheduledActionsStage implements StageDefinitionBuilder {
  @Override
  public void taskGraph(Stage stage, TaskNode.Builder builder) {
    builder
        .withTask("upsertTencentScheduledActions", UpsertTencentScheduledActionsTask.class)
