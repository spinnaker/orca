...
@Slf4j
@Component
class CloudFoundryServerGroupCreator extends CloudFoundryServerGroupOps implements ServerGroupCreator {
  ...
  public List<Map> getOperations(Stage stage) {
    ...
    ImmutableMap.Builder<String, Object> operation = ImmutableMap.<String, Object>builder()
      ...
      .put("manifest", getManifestArtifact(stage, context.get("manifest")));
