...
public class HuaweiCloudSecurityGroupUpserter implements SecurityGroupUpserter, CloudProviderAware {
  ...
  @Override
  public SecurityGroupUpserter.OperationContext getOperationContext(StageExecutionImpl stage) {
  ...
  public boolean isSecurityGroupUpserted(
      MortService.SecurityGroup upsertedSecurityGroup, StageExecutionImpl stage) {
