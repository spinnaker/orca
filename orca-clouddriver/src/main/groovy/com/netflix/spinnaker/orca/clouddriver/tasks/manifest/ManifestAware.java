...
public interface ManifestAware {
  default Map<String, List<String>> manifestNamesByNamespace(StageExecutionImpl stage) {
  ...
  default Map<String, List<String>> manifestsToRefresh(StageExecutionImpl stage) {
    Map<String, List<String>> result =
        (Map<String, List<String>>)
            stage
                .getContext()
