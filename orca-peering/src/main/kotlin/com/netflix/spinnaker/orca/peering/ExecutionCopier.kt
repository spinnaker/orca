...
open class ExecutionCopier(
   ...
   */
  open fun copyInParallel(executionType: PipelineExecution.ExecutionType, idsToMigrate: List<String>, state: ExecutionState): MigrationChunkResult {
   ...
   */
  private fun copyExecutionChunk(executionType: PipelineExecution.ExecutionType, idsToMigrate: List<String>, state: ExecutionState): MigrationChunkResult {
    var latestUpdatedAt = 0L
    try {
