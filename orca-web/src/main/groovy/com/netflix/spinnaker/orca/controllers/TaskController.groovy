 ...
 */
  ...
  List<PipelineExecution> getPipelinesForApplication(@PathVariable String application,
    ...
    def pipelineConfigIds = front50Service.getPipelines(application, false, this.configurationProperties.excludeExecutionsOfDisabledPipelines ? "enabled" : "all")*.id as List<String>
