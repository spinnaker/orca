...
public class ArtifactExpressionFunctionProvider implements ExpressionFunctionProvider {
    ...
    return new Functions(
        new FunctionDefinition(
            ...
            new FunctionParameter(
                PipelineExecutionImpl.class, "execution", "The execution to search for artifacts"),
  ...
  public static Artifact triggerResolvedArtifact(PipelineExecutionImpl execution, String name) {
    return triggerResolvedArtifactBy(execution, name, artifact -> name.equals(artifact.getName()));
  }

  public static Artifact triggerResolvedArtifactByType(
      PipelineExecutionImpl execution, String type) {
  ...
  private static Artifact triggerResolvedArtifactBy(
      PipelineExecutionImpl execution, String nameOrType, Predicate<Artifact> predicate) {
