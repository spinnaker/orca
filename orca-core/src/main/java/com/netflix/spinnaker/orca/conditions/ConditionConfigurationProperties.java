...
public class ConditionConfigurationProperties {
  ...
  public Long getBackoffWaitMs() {
    return configService.getConfig(Long.class, "tasks.evaluate-condition.backoff-wait-ms", backoffWaitMs);
  }
  ...
  public long getWaitTimeoutMs() {
    return configService.getConfig(Long.class, "tasks.evaluate-condition.wait-timeout-ms", waitTimeoutMs);
  }
  ...
  public List<String> getActiveConditions() {
    return configService.getConfig(List.class, "tasks.evaluate-condition.active-conditions", activeConditions);
  }
