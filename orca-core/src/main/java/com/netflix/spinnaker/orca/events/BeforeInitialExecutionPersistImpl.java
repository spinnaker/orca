...
import com.netflix.spinnaker.orca.api.pipeline.events.BeforeInitialExecutionPersist;
import com.netflix.spinnaker.orca.api.pipeline.models.PipelineExecution;
import javax.annotation.Nonnull;
import org.springframework.context.ApplicationEvent;

/** An event emitted immediately before the initial persist of an execution. */
public final class BeforeInitialExecutionPersistImpl extends ApplicationEvent
    implements BeforeInitialExecutionPersist {

  private final PipelineExecution execution;

  public BeforeInitialExecutionPersistImpl(
