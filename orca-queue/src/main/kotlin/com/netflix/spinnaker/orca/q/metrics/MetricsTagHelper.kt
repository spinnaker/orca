...
class MetricsTagHelper : CloudProviderAware {
  companion object {
    ...
    fun commonTags(stage: StageExecutionImpl, taskModel: TaskExecution, status: ExecutionStatus): Iterable<BasicTag> =
      arrayListOf(
    ...
    fun detailedTaskTags(stage: StageExecutionImpl, taskModel: TaskExecution, status: ExecutionStatus): Iterable<BasicTag> =
      arrayListOf(
